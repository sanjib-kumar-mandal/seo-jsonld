 ...
 * 3. BlogPosting
 */
export const artical = (data: ArticalStructuredData) => {
    return {
 ...
 */
export const breadCrump = (data: BreadcrumbStructureData | Array<BreadcrumbStructureData>) => {
 ...
 * 1. Course
 */
export const course = (data: CourseStructureData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 */
export const covid19 = (data: Covid19StructuredData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 */
export const dataSet = (data: DatasetStructureData) => {
    return data ? {
        "@context": "https://schema.org/",
 ...
 */
export const educationalQA = (data: EducationalQAStructuredData) => {
    return data ? {
        "@context": "https://schema.org/",
        "@type": data.type ?? 'Quiz',
        ...(data.about && {
 ...
 */
export const event = (eventInfo: EventStructuredData) => {
    return eventInfo ? {
        "@context": "https://schema.org",
        "@type": "Event",
 ...
 * 3. Rating
 */
export const factCheck = (data: FactCheckStructuredData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 */
export const faq = (data: FAQStructuredData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 */
export const jobPosting = (data: JobPostingStructureData) => {
    return {
        "@context": "https://schema.org/",
 ...
 */
export const localBusiness = (data: LocalBusinessStructuredData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 */
export const logo = (data: LogoStructuredData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 */
export const movie = (data: Array<MovieStructuredData>) => {
    return data ? {
        "@context": "https://schema.org",
        "@type": "ItemList",
        ...(data?.length && {
...
export const review = (data: ReviewStructuredData) => {
    return data ? {
        "@context": "https://schema.org/",
        "@type": data.type ?? 'Restaurant',
        ...(data.name && { "name": data.name }),
 ...
 */
export const searchBox = (data: SearchBoxStructuredData) => {
 ...
 */
export const softwareApplication = (data: SoftwareApplicationStructureData) => {
    return data ? {
        "@context": "https://schema.org",
 ...
 * 4. Update blog page
 */
export const video = (data: VideoStructureData) => {
    return data ? {
        "@context": "https://schema.org",
